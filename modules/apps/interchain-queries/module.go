...
import (
	...
	"github.com/cosmos/ibc-go/v3/modules/apps/interchain-queries/client/cli"
	controllerkeeper "github.com/cosmos/ibc-go/v3/modules/apps/interchain-queries/controller/keeper"
	controllertypes "github.com/cosmos/ibc-go/v3/modules/apps/interchain-queries/controller/types"
	"github.com/cosmos/ibc-go/v3/modules/apps/interchain-queries/host"
	hostkeeper "github.com/cosmos/ibc-go/v3/modules/apps/interchain-queries/host/keeper"
	hosttypes "github.com/cosmos/ibc-go/v3/modules/apps/interchain-queries/host/types"
...
// AppModuleBasic is the IBC interchain queries AppModuleBasic
...
// RegisterGRPCGatewayRoutes registers the gRPC Gateway routes for the interchain queries module.
...
// AppModule is the application module for the IBC interchain queries module
...
// NewAppModule creates a new IBC interchain queries module
...
// InitModule will initialize the interchain queries moudule. It should only be
...
// InitGenesis performs genesis initialization for the interchain query module.
...
// ExportGenesis returns the exported genesis state as raw bytes for the interchain query module
